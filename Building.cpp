...
Building::Building(float height, float offset)
{
	toWorld = glm::mat4(1.0f);

	// FRONT vertices
	vertices.push_back(glm::vec3(-0.5f + offset, -0.5f, 0.5f));	// bottom left
	vertices.push_back(glm::vec3(0.5f + offset, -0.5f, 0.5f));	// bottom right
	vertices.push_back(glm::vec3(0.5f + offset, height, 0.5f));	// top right
	vertices.push_back(glm::vec3(-0.5f + offset, height, 0.5f));	// top left
